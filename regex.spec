...
Source0  : https://files.pythonhosted.org/packages/38/3f/4c42a98c9ad7d08c16e7d23b2194a0e4f3b2914662da8bc88986e4e6de1f/regex-2021.4.4.tar.gz
...
%prep
%setup -q -n regex-2021.4.4
cd %{_builddir}/regex-2021.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617639153
...
cp %{_builddir}/regex-2021.4.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
