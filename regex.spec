...
Source0  : https://files.pythonhosted.org/packages/b5/48/91b0da3e87300e300f30dad9a71faa8777a5a961ceeb9f21384a37f7bf59/regex-2020.10.23.tar.gz
...
%prep
%setup -q -n regex-2020.10.23
cd %{_builddir}/regex-2020.10.23
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603465562
