...
Source0  : https://files.pythonhosted.org/packages/4c/69/acbf9b28cc1b699ef8d5152c40e0fc130d120ef13187f0fd54dd4afb7770/regex-2021.9.30.tar.gz
...
%prep
%setup -q -n regex-2021.9.30
cd %{_builddir}/regex-2021.9.30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633102970
...
cp %{_builddir}/regex-2021.9.30/LICENSE.txt %{buildroot}/usr/share/package-licenses/regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
