...
Source0  : https://files.pythonhosted.org/packages/c0/d1/ad6afa6000ab869f6af2c85985d40558ffb298d9fcb2ab04c0648436008f/regex-2021.7.6.tar.gz
...
%prep
%setup -q -n regex-2021.7.6
cd %{_builddir}/regex-2021.7.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625589145
...
cp %{_builddir}/regex-2021.7.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
